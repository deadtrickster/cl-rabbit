...
(cstruct amqp-connection-close-ok-t "amqp_connection_close_ok_t"
         (dummy "dummy" :type :char))
...
(cstruct amqp-queue-purge-ok-t "amqp_queue_purge_ok_t"
         (message-count "message_count" :type uint32-t))
...
(cstruct amqp-field-value-t "amqp_field_value_t"
         ...
         (value-timestamp "value.u64" :type uint64-t)
